...
Repo: [coilysiren/galaxy-gen](https://github.com/coilysiren/galaxy-gen). Stack: Rust to WASM in the browser. Sister skill: [`coding-galaxy-gen-astrophysics`](../coding-galaxy-gen-astrophysics/SKILL.md) covers galaxy-scale physics.
